<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="uc_Student.ascx.cs" Inherits="WEB_APP_SCHOOL_NET.UC.uc_Student" %>
...
<div class="box box-primary">
    <div class="box-header with-border">
        ...
        <div class="box-tools pull-right">
            <asp:LinkButton ID="lkbBack" CssClass="btn btn-danger pull-right" EnableTheming="false" OnClick="lkbBack_Click" runat="server">&nbsp;<i class="fa fa-backward"></i> Back</asp:LinkButton>
        </div>
    </div>
    <div class="box-body">
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <div class="checkbox checkboxlist col-md-12">
                        <asp:CheckBoxList ID="cblListSubject" CssClass="list-unstyled checkbox checkboxlist-inline" RepeatDirection="Vertical" RepeatLayout="UnorderedList" DataTextField="SubjectName" DataValueField="SubjectId" runat="server">
                        </asp:CheckBoxList>
                    </div>
                </div>
            </div>
