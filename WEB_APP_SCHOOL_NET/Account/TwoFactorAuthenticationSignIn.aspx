<%@ Page Title="Two-Factor Authentication" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TwoFactorAuthenticationSignIn.aspx.cs" Inherits="WEB_APP_SCHOOL_NET.Account.TwoFactorAuthenticationSignIn" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:PlaceHolder runat="server" ID="sendcode">
        <section>
            ...
            <asp:DropDownList style="width:100%" runat="server" ID="Providers">
            </asp:DropDownList>
